...
<body>
  ...
  <!-- Begin Navbar -->
  <div id="nav">
    <div class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="100" id="cont">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="inicio.php"><b>Abarrotes Getsemaní</b></a>
        </div>
      ...
      <?php
       if($_SESSION['usuario']=="admin"):
         ...
         <?php 
          ...
          <li class="dropdown" >
            <a href="#" style="color: cyan"  class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> <b>Usuario: <?php echo $_SESSION['usuario']; ?>  </b><span class="caret"></span></a>
            <ul class="dropdown-menu">
