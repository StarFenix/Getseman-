<?php
	...
	function registraUsuario($usuario, $pass_hash, $nombre, $email, $activo, $tipo_usuario){
		
		global $mysqli;
		
		$stmt = $mysqli->prepare("INSERT INTO usuarios (usuario, password, nombre, correo, activacion, id_tipo) VALUES(?,?,?,?,?,?)");
		$stmt->bind_param('ssssii', $usuario, $pass_hash, $nombre, $email, $activo, $tipo_usuario);
